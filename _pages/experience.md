...
description: Professional experience, education, and technical focus.
nav: true
nav_order: 2
---
...
<div class="fv-page">
  ...
  <div class="fv-timeline-item">
    <div class="fv-timeline-date">2013 — 2017</div>
    <div><h3>MIT · PhD in Computational Science and Engineering</h3><p>Minor in Machine Learning. Thesis: <em>Simulation Methods for Plasmonics</em>.</p></div>
  </div>
  <div class="fv-timeline-item">
  ...
  <p><strong>Cloud and data:</strong> GCP, AWS, BigQuery, Redshift, Spark, DuckDB, Neo4j, MongoDB, Prefect, Airflow, RabbitMQ, gRPC</p>
  <p><strong>Engineering:</strong> Docker, Git, FastAPI, Next.js, React, Tailwind CSS</p>

  <h2>Languages</h2>
  <p>Catalan and Spanish (native) · English (fluent)</p>
</div>
